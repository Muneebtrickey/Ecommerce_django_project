...
# Helper function to generate a unique file path for uploaded images
# Renamed first argument from 'request' to 'instance' to match Django's upload_to signature
...
class Category(models.Model):
    """
    Represents a product category (e.g., Electronics, Fashion).
    """
...
class Order(models.Model):
    ...
    # Renamed from 'statuc' to 'status' for correctness
